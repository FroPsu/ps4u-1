...
class NCBrandColor: NSObject {
    ...
    // Color
    @objc public let customer:              UIColor = UIColor(red: 226.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)    // Neu: E20000; ALt: BLU NC : #0082c9
    ...
    @objc public let nextcloud:             UIColor = UIColor(red: 226.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)      // auch geaendert
